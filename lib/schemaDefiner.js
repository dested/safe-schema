        ...
        default:
            ...
            switch (schema.flag) {
                ...
                case 'array-uint32': {
                    ...
                    return `${size}+sum(${fieldName}.map(${noPeriodsFieldName + 'Element'}=>(${buildAdderSizeFunction(schema.elements, noPeriodsFieldName + 'Element', addMap, customSchema)}0)))+`;
                }
                case 'type-lookup': {
                    let map = '{\n';
                    let index = 0;
